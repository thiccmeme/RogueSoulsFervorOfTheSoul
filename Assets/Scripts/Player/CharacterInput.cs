...
public partial class @CharacterInput: IInputActionCollection2, IDisposable
{
    ...
    ~@CharacterInput()
    {
        Debug.Assert(!m_CharacterMovement.enabled, "This will cause a leak and performance issues, CharacterInput.CharacterMovement.Disable() has not been called.");
        Debug.Assert(!m_CharacterActions.enabled, "This will cause a leak and performance issues, CharacterInput.CharacterActions.Disable() has not been called.");
    }
